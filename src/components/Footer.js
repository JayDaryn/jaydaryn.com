...
const Footer = () => {
	return(
        ...
        <div>
					<a style={{fontSize:'1.3em'}}  href="https://www.canva.com/design/DAFJVXpFjLk/7zOlmtVLF90buO_3iHEP3g/view?website#2" target="_blank" rel="noopener noreferrer">Become a Sponsor 💸</a>
        </div>
